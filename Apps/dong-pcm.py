...
pts.mc.num_nvm_ranks_per_mc  = 1

# parameters that start with 'pts.mc.t[capital letter]'
# have the unit of 'pts.mc.process_interval' ticks.
# Dong: the nvm parameters are based on the following paper 
# "Architecting Phase Change Memory as a Scalable DRAM Alternative" (ISCA'09)
pts.mc.tRCD         = 14
pts.mc.tRCD_nvm	    = 62
pts.mc.tRAS         = 34	#tRAS=tCL+tRCD+6 (see http://www.tweakers.fr/timings.html#tRTP)
pts.mc.tRAS_nvm     = 82	#tRAS_nvm=tCL+tRCD_nvm+6 
pts.mc.tRP          = 14
pts.mc.tRP_nvm      = 168
pts.mc.tRR          = 1
pts.mc.tCL          = 14
